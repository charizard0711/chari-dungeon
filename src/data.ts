...
export const WEAPON_DEFS: WeaponDef[] = [
  { key: 'w_screw', name: 'スパイラルランス', atkMin: 5, atkMax: 12, durMax: 40, minFloor: 1, rarity: 10 },
  { key: 'w_star', name: 'ステラブレード', atkMin: 7, atkMax: 15, durMax: 35, minFloor: 1, rarity: 8 },
  { key: 'w_gearhammer', name: 'ギガギアハンマー', atkMin: 10, atkMax: 22, durMax: 55, minFloor: 4, rarity: 6 },
  { key: 'w_rune', name: 'ルーンブレード', atkMin: 12, atkMax: 26, durMax: 60, minFloor: 6, rarity: 5 },
  { key: 'w_vine', name: 'ローズウィップ', atkMin: 9, atkMax: 20, durMax: 50, minFloor: 5, rarity: 6 },
  { key: 'w_candle', name: 'ルミナスタッフ', atkMin: 11, atkMax: 24, durMax: 60, minFloor: 8, rarity: 5 },
  { key: 'w_compass', name: 'アジマススピア', atkMin: 8, atkMax: 18, durMax: 38, minFloor: 3, rarity: 7 },
  { key: 'w_dark', name: 'ノクティスファング', atkMin: 15, atkMax: 30, durMax: 75, minFloor: 12, rarity: 4 },
  { key: 'w_gearaxe', name: 'ジャッジアックス', atkMin: 18, atkMax: 36, durMax: 95, minFloor: 15, rarity: 3 },
  { key: 'w_gravity', name: 'グラビティロッド', atkMin: 20, atkMax: 44, durMax: 90, minFloor: 20, rarity: 2 },
  // ===== 二刀流（レア・2回攻撃・盾装備不可）=====
  { key: 'w_twin', name: 'リンクスエッジ', atkMin: 8, atkMax: 16, durMax: 80, minFloor: 8, rarity: 2, dual: true },
  { key: 'w_soulblades', name: 'ゲミノスブレード', atkMin: 13, atkMax: 24, durMax: 100, minFloor: 16, rarity: 1, dual: true }
];
...
export const SHIELD_DEFS: ShieldDef[] = [
  { key: 's_gear', name: 'ギアシールド', defBonus: 2, durMax: 40, minFloor: 1 },
  { key: 's_crystal', name: 'クリスタルシールド', defBonus: 4, durMax: 55, minFloor: 8 },
  { key: 's_skull', name: 'スカルシールド', defBonus: 6, durMax: 70, minFloor: 16 }
];
